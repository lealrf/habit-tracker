...
def generate_predefined_data():
    ...
    predefined_habits =[
        Habit(name="Drink Water", description="Drink 2 liters of water", periodicity="daily"),
        ...
        Habit(name="Study Python", description="Work on Python projects", periodicity="weekly")
    ]
